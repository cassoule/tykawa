/**
 *******************************************************************************
 * @file	stm32g4_nfc03a1.h
 * @author	Julie			&& vchav
 * @date	1 janv. 2017	&& Jul 9, 2024 --> portage sur stm32g431
 * @brief	Module pour utiliser le NFC03A1
 *******************************************************************************
 */
#ifndef BSP_NFC03A1_STM32G4_NFC03A1_H_
#define BSP_NFC03A1_STM32G4_NFC03A1_H_
...
#define NFC_INTERFACE_GPIO_PORT			GPIOB
#define NFC_INTERFACE_PIN				GPIO_PIN_4
/* Exported types ------------------------------------------------------------*/
